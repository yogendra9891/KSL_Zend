...
class ClassifiedController extends AbstractActionController {
    ...
    public function uploadFormAction()
    {
    	...
    	if ($request->isPost()) {
			...
			//defining the image path for original, thumb and standarad
    ...
    public function deletePostImageAction()
    {
    	...
    	if ($result->id) {
	    	...
	    	$dbFileName = $result->image;
	    	$original_file = dirname(__DIR__).static::ORIGINAL_IMAGE.$dbFileName;
	    	$standard_file = dirname(__DIR__).static::STANDARD_IMAGE.$dbFileName;
	    	$thumb_file    = dirname(__DIR__).static::THUMB_IMAGE.$dbFileName;
